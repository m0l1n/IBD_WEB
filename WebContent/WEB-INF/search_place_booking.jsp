		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-header">
					<h1>Réserver une place pour un spectacle</h1>
				</div>
				<%
				...
				<form role="form" action="" method="post">
					...
					<div class="form-group">
						<label for="numZ">Numéro de zone désiré : </label>
						<input type="number" class="form-control" name="numZ" id="numZ" placeholder="Renseignez le numéro de zone">
					</div>
